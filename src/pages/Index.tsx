...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100" dir="rtl">
      {/* Header with improved logo placement */}
      <header className="bg-white/95 backdrop-blur-md shadow-lg border-b border-blue-200 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            {/* Logo section with better design */}
            <div className="flex items-center space-x-3 space-x-reverse">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-500 rounded-xl flex items-center justify-center shadow-lg transform rotate-3 hover:rotate-0 transition-transform duration-300">
            ...
            <nav className="hidden md:flex items-center space-x-6 space-x-reverse">
              ...
              <Button onClick={() => navigate('/join-us')} className="bg-blue-500 hover:bg-blue-600 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                انضم إلينا
              </Button>
            </nav>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button 
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
              >
                ابدأ مشروعك معنا
      ...
      <section className="py-16 bg-white/50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-blue-700 mb-12">خدماتنا المتنوعة</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {stats.map((stat, index) => (
              <div key={index}>
                <div className="text-5xl font-bold text-blue-700 mb-2">{stat.value}</div>
                <div className="text-lg text-blue-600">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-white/50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-blue-700 mb-12">آراء عملائنا</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="border-0 shadow-lg">
                <CardHeader>
                  <CardTitle className="text-xl text-blue-700">{testimonial.name}</CardTitle>
                  <CardDescription className="text-blue-600">{testimonial.company}</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-blue-600">{testimonial.quote}</p>
                </CardContent>
              </Card>
            ))}
          </div>
