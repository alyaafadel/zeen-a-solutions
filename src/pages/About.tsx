    ...
    <div className="min-h-screen bg-pattern-subtle" dir="rtl">
      ...
      <div className="container mx-auto px-8 py-20 max-w-6xl">
        ...
        <section className="text-center mb-24">
          <h1 className="text-5xl md:text-6xl font-bold text-brand-blue mb-10 leading-tight">
            من نحن: Zeen-A Solutions
          </h1>
          <h2 className="text-3xl md:text-4xl font-semibold text-brand-blue-dark mb-12">
            شركاؤكم في التميز والإنجاز
          </h2>
          <div className="max-w-5xl mx-auto space-y-10 text-xl text-slate-600 leading-relaxed">
        ...
        <section className="mb-28">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-brand-blue mb-6">رؤيتنا ورسالتنا</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <Card className="h-full group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-0 shadow-lg bg-white/95 backdrop-blur-sm">
              <CardHeader className="text-center pb-8">
                <div className="w-24 h-24 bg-gradient-blue rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <Eye className="h-12 w-12 text-white" />
                </div>
                <CardTitle className="text-3xl text-brand-blue group-hover:text-brand-blue-dark transition-colors duration-300">رؤيتنا</CardTitle>
              </CardHeader>
            ...
            <Card className="h-full group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-0 shadow-lg bg-white/95 backdrop-blur-sm">
              <CardHeader className="text-center pb-8">
                <div className="w-24 h-24 bg-gradient-blue-light rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <Target className="h-12 w-12 text-white" />
                </div>
                <CardTitle className="text-3xl text-brand-blue group-hover:text-brand-accent-blue transition-colors duration-300">رسالتنا</CardTitle>
              </CardHeader>
              <CardContent className="px-10 pb-10">
                <p className="text-slate-700 leading-relaxed text-xl text-center">
        ...
        <Separator className="mb-28 bg-gradient-blue-light h-1 rounded-full" />

        {/* Core Values Section */}
        <section className="mb-28">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-brand-blue mb-8">قيمنا الأساسية</h2>
            <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            ...
            {coreValues.map((value, index) => (
              <Card key={index} className="h-full group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-0 shadow-lg bg-white/95 backdrop-blur-sm">
                <CardHeader className="text-center pb-6">
                  ...
                  <CardTitle className="text-2xl text-brand-blue group-hover:text-brand-blue-dark transition-colors duration-300">{value.title}</CardTitle>
                </CardHeader>
                <CardContent className="px-8 pb-8">
                  <p className="text-slate-700 leading-relaxed text-center text-lg">{value.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <Separator className="mb-28 bg-gradient-dark-blue h-1 rounded-full" />

        {/* What Makes Us Different Section */}
        <section className="mb-28">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-brand-blue mb-8">ما يميزنا</h2>
            <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
              ...
              <Card key={index} className="h-full group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-0 shadow-lg bg-white/95 backdrop-blur-sm">
                <CardHeader className="pb-6">
                  <div className="flex items-center space-x-4 space-x-reverse">
                    ...
                    <CardTitle className="text-2xl text-brand-blue group-hover:text-brand-blue-dark transition-colors duration-300">{item.title}</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="px-8 pb-8">
        ...
        <section className="mb-28">
          <Card className="bg-gradient-to-br from-brand-light-blue/50 to-brand-light-blue/30 border-0 shadow-xl">
            <CardHeader className="text-center pb-8">
              <div className="w-24 h-24 bg-gradient-blue rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg">
                <Users className="h-12 w-12 text-white" />
              </div>
              <CardTitle className="text-4xl text-brand-blue mb-8">كيف نعمل؟</CardTitle>
            </CardHeader>
            <CardContent className="text-center space-y-10 px-10 pb-10">
              <p className="text-xl text-slate-700 leading-relaxed max-w-5xl mx-auto">
              ...
              <div className="flex items-center justify-center space-x-3 space-x-reverse">
                ...
                <span className="text-slate-600 font-medium text-lg">تقييم شركائنا لجودة خدماتنا</span>
              </div>
            </CardContent>
          </Card>
        </section>
        ...
        <section className="text-center">
          <Card className="bg-gradient-to-br from-brand-blue to-brand-blue-dark text-white border-0 shadow-2xl">
            <CardHeader className="pb-8">
              <CardTitle className="text-4xl md:text-5xl font-bold mb-8">
                دعوة للعمل
              </CardTitle>
              <CardDescription className="text-2xl text-brand-light-blue mb-12 max-w-5xl mx-auto leading-relaxed">
            ...
            <CardContent className="px-10 pb-10">
              <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
                <WhatsAppButton 
                  ...
                  className="bg-white text-brand-blue hover:bg-brand-light-blue hover:text-brand-blue-dark border-0 px-12 py-5 text-xl font-bold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 rounded-lg"
                />
                <Button
                  variant="outline"
                  size="lg"
                  onClick={() => navigate('/')}
                  className="border-2 border-white text-white hover:bg-white hover:text-brand-blue px-12 py-5 text-xl font-bold transition-all duration-300 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  اكتشف خدماتنا
                </Button>
              </div>
