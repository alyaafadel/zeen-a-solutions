    ...
    <div className="min-h-screen bg-pattern-subtle" dir="rtl">
      ...
      <div className="container mx-auto px-8 py-16 max-w-6xl">
        ...
        <section className="text-center mb-20">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-brand-blue-dark mb-10">
            شركاؤكم في التميز والإنجاز
          </h2>
          <div className="max-w-5xl mx-auto space-y-8 text-lg text-slate-600 leading-relaxed">
        ...
        <Separator className="mb-20 bg-gradient-blue h-1 rounded-full" />

        {/* Vision and Mission Section with proper spacing */}
        <section className="mb-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-brand-blue mb-6">رؤيتنا ورسالتنا</h2>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <Card className="h-full group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-0 shadow-lg bg-white/95 backdrop-blur-sm">
              <CardHeader className="text-center pb-6">
                <div className="w-20 h-20 bg-gradient-blue rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <Eye className="h-10 w-10 text-white" />
                </div>
                <CardTitle className="text-2xl text-brand-blue group-hover:text-brand-blue-dark transition-colors duration-300 mb-4">رؤيتنا</CardTitle>
              </CardHeader>
            ...
            <Card className="h-full group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-0 shadow-lg bg-white/95 backdrop-blur-sm">
              <CardHeader className="text-center pb-6">
                <div className="w-20 h-20 bg-gradient-blue-light rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <Target className="h-10 w-10 text-white" />
                </div>
                <CardTitle className="text-2xl text-brand-blue group-hover:text-brand-accent-blue transition-colors duration-300 mb-4">رسالتنا</CardTitle>
              </CardHeader>
              <CardContent className="px-8 pb-8">
                <p className="text-slate-700 leading-relaxed text-lg text-center">
        ...
        <Separator className="mb-24 bg-gradient-blue-light h-1 rounded-full" />

        {/* Core Values Section with proper spacing */}
        <section className="mb-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-brand-blue mb-6">قيمنا الأساسية</h2>
            <p className="text-lg text-slate-600 max-w-4xl mx-auto leading-relaxed mb-8">
            ...
            {coreValues.map((value, index) => (
              <Card key={index} className="h-full group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-0 shadow-lg bg-white/95 backdrop-blur-sm">
                <CardHeader className="text-center pb-6">
                  ...
                  <CardTitle className="text-xl text-brand-blue group-hover:text-brand-blue-dark transition-colors duration-300 mb-4">{value.title}</CardTitle>
                </CardHeader>
        ...
        <Separator className="mb-24 bg-gradient-dark-blue h-1 rounded-full" />

        {/* What Makes Us Different Section with proper spacing */}
        <section className="mb-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-brand-blue mb-6">ما يميزنا</h2>
            <p className="text-lg text-slate-600 max-w-4xl mx-auto leading-relaxed mb-8">
        ...
        <section className="mb-20">
          <Card className="bg-gradient-to-br from-brand-light-blue/50 to-brand-light-blue/30 border-0 shadow-xl">
            <CardHeader className="text-center pb-6">
              <div className="w-20 h-20 bg-gradient-blue rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <Users className="h-10 w-10 text-white" />
              </div>
              <CardTitle className="text-3xl text-brand-blue mb-6">كيف نعمل؟</CardTitle>
            </CardHeader>
            <CardContent className="text-center space-y-8 px-8 pb-8">
              <p className="text-lg text-slate-700 leading-relaxed max-w-4xl mx-auto mb-6">
        ...
        <section className="text-center">
          <Card className="bg-gradient-to-br from-brand-blue to-brand-blue-dark text-white border-0 shadow-2xl">
            <CardHeader className="pb-6">
              ...
              <CardDescription className="text-xl text-brand-light-blue mb-8 max-w-4xl mx-auto leading-relaxed">
