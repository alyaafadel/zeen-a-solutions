      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl font-bold text-gray-800 mb-6">خدمات الترجمة الاحترافية</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl font-bold text-gray-800 mb-4">اللغات المدعومة</h3>
            <p className="text-xl text-gray-600">نقدم خدمات الترجمة بين مختلف اللغات العالمية</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {supportedLanguages.map((language, index) => (
              <div key={index} className="text-center p-4 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div className="text-lg font-semibold text-gray-800">{language}</div>
              </div>
            ))}
          </div>
        </div>
